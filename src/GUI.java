...
public class GUI {
    public static void main(String[] args) {
       ...
       // CommonData.Level level = CommonData.Level.BEGINNER;
        ...
        Course2 course2 = new Course2("Database Management", "Information Systems", CommonData.Department.SCIENCE,days,CommonData.Time.At_11_30,CommonData.Level.INTERMEDIATE,"Prof. Johnson", "Database design and management");
        Course2 course3 = new Course2("Advanced Calculus", "Mathematics", CommonData.Department.MATH,days,CommonData.Time.At_13_30,CommonData.Level.ADVANCED,"Prof. Brown", "Advanced calculus concepts");
